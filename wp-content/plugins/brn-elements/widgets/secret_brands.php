		...
		<div class="brands_con <?=$is_slider ? "swiper-container" : ""?>" id="brands_con_<?=$rand_id?>">
            ...
            <a href="/brand/<?=$brand->slug?>/" class="brand_con <?=$is_slider ? "swiper-slide" : "" ?>">
            	<?
					...
					$img = !isset($brand->fields['homepage_image']) || empty($brand->fields['homepage_image']) ? wp_get_attachment_url( get_term_meta($brand->term_id, 'thumbnail_id', true) ) : $brand->fields['homepage_image'];          
				?>
