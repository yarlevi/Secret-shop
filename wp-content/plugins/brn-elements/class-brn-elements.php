 ...
 * @author     BRN <admin@brn.co.il>
 * @copyright  2021 BRN
 * @license    https://opensource.org/licenses/GPL-3.0 GPL-3.0-only
 * @link       link(https://www.brn.co.il,
 *             Website Developers)
 * @since      1.0.0
 * php version 7.3.9
 */
...
/**
 * Main BRN Elements Class
 *
 * The init class that runs the BRN Elements plugin.
...
final class Brn_Elements {
	...
	public function i18n() {
		load_plugin_textdomain( 'brn-elements' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( BRN_ELEMENTS ) );
